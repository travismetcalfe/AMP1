...
c
      return
c
9030  write(istdou,*)'readk: open error of ',kurtab
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*)
     *  'readk: open error of ',kurtab
      stop 'in dreadk'
9700  write(istdou,*)'readk: array-dimension error of zval,nz= ',nz 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*)
     *  'readk: array-dimension error of zval,nz= ',nz 
      stop 'in dreadk'
9710  write(istdou,*)'readk: inconsistency-error of opk,iz= ',iz 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*)
     *  'readk: inconsistency-error of opk,iz= ',iz 
      stop 'in dreadk'
9720  write(istdou,*)'readk: inconsistency-error of tlk,mt= ',mt 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*)
     *  'readk: inconsistency-error of tlk,mt= ',mt 
      stop 'in dreadk'
9730  write(istdou,*)'readk: inconsistency-error of rlk:md,mdr= ',md,mdr
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*)
