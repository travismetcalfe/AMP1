...
C define parameters                            
C==============================================
      integer nel, istdin, istdou, istdpr, istder
      parameter ( nel = 10 )
...
C**********************************************
      ...
      yt = z_r+y_r+x_r
c     if(istdpr.gt.0) write(istdpr,1003) x_r,y_r,z_r
...
c     if(istdpr.gt.0) write(istdpr,1001) atw_m,yt,xt
c1001 format(' mean atomic weight ',f8.4,'; sum of number/mass abnds. ',
c    $2f8.3)
c     do i = 1, nel
c       if(istdpr.gt.0) write(istdpr,1002) z(i),atw(i),y(i),x(i)
c     end do
