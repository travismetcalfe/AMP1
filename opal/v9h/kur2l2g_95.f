...
c
      ...
      write(istdpr,*)'index at fitting point tlm= ',tlm
      write(istdpr,*)'upper index of Kurucz-tables ',
     +        'extrapoint jlo= ',jlo
c
...
c
      ...
      llo=llo+1
      write(istdpr,*)'lower index of Livermore-tables llo= ',llo
      write(istdpr,*)'tlgl_min= ',tlgl(llo,1,1)
c
c======================================================================
c
c
...
4002  continue
      ...
      if(itlgc.ge.ntlgc)then
        write(istdpr,*)'array dimension error of tlgc: ',itlgc
      endif
c
c======================================================================
c
...
c     
      l=8
      write(istdpr,*)'output test-table Z=',zli(l)
...
c
      stop
c
9030  write(istdpr,*)'ku2o95: error in opening ',tabnam
      stop
9040  write(istdpr,*)'ku2o95: array-dim error of it'
      stop
9050  write(istdpr,*)'ku2o95: wrong nr. of tablepoints',ip,lkur
      stop
c
      end
