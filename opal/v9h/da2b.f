...
c	  read 1st 6 lines 
	  do 1001 i=1,6
	   read(lun,'(a)') line
           if (i.eq.3) write(istdpr,*)ifname(l),line(44:62)
 1001     continue	
c
...
c	  read/write t6/log10(t) & opacity-values
 ...
 1010     continue
c     	  write(istdpr,*)'da2b: ',j-1,' lines read in file ',ifname(k)
 3001     continue
	  close(lun)
 1015   continue
	close(lun+1)
c
	stop
c
 9001   write(istdpr,*)'da2b: error in opening ',ifname(k),'lun= ',lun
	stop
 9011   write(istdpr,*)'da2b: error in opening ',ofname,'lun= ',lun+1
	stop
 9002	write(istdpr,*)'da2b: error in reading: line: ',j
	stop
 9020   write(istdpr,*)'da2b: error in writing ',ofname,'lun= ',lun+1 
        stop
c
	end
