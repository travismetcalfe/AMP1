...
c      05/10/2002 modfued for Frank Pipers OPAL02 tables
c      05Sep2004  modfied for Frank Pipers OPAL04 tables (01092004)
c      23Feb0606  modfied for Asplund-Grevesse-Sauval compostion OPAL_AGS05
c
c       last modification: 22/02/2006
c
c       Variables:
c       lun ....... logical unit number of opacity-table-file
c       ntab ...... nr. of opacity tables/file (different X-tables)
...
c         read/write logT & opacity-values
     ...
     +           tlg(j,k)           ,(opa(i,j,k),i=1,nval)
 1010     continue
c         print *,'opalb: ',j-1,' lines read in file ',ifname
 1015     continue
 3001 continue
      close(lun+1)
c
      stop
c
 9001 print *,'opalb: error in opening ',ifname,'lun= ',lun
      stop
 9011 print *,'opalb: error in opening ',ofname,'lun= ',lun+1
      stop
 9002 print *,'opalb: error in reading: line: ',j
      stop
 9020 print *,'opalb: error in writing ',ofname,'lun= ',lun+1 
      stop
c
      end
