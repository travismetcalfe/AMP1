...
c     05/10/02: modified to use Frank Piper's OPAL02 tables
c     05/09/04: modified to use Frank Piper's OPAL04 tables (01092004)
c     05/09/04: modified to use Frank Piper's OPAL04 tables (01092004)
...
c     input files (optabe.bin,ival.dat)
c
      open(29,file='OPAL_X',
...
c
      call rde05(lun,optabe,ntab,nxi,nyi,nzva,rlg,tlg,opa,ival)
c
...
c
      stop
c
6000  format('extrapolation of table:',3i3)
9010  print *,'opal_exak: error in opening of file ',ivadat
      stop
9030  print *,'opal_exak: error in opening of OPAL_X'
      stop
c
      end
