...
d     if (ieeer .ne. 0) print *, 'ieee_handler i cant be set !!'
d     ieeer = ieee_handler ('set', 'division', myhandlerd)
d     if (ieeer .ne. 0) print *, 'ieee_handler d cant be set !!'
d     ieeer = ieee_handler ('set', 'overflow', myhandlero)
d     if (ieeer .ne. 0) print *, 'ieee_handler o cant be set !!'
d     ieeer = ieee_handler ('set', 'underflow', myhandleru)
d     if (ieeer .ne. 0) print *, 'ieee_handler u cant be set !!'
c
c
      itab=1
