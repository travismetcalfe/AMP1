...
c
c     24Feb06 : modified for using extrapolated OPAL * AF05 tables
c
...
c---- between s/r opinit and s/r opintf
...
c
     ...
     *     '***WARNING*** opintf: setting Z=1.d-7'
         zval=1.0d-7
         zvall=-7.0d0
      else
         zvall=dlog10(zval)
...
c          do not check if point lies in the extrapolation domain (->speed)
...
c
c
d9710 write(istdpr,*) 'opintf: error in common-array nxir'
d     ier=2
d     return
d9720 write(istdpr,*) 'opintf: error in common-array nyir'
d     ier=2
d     return
d9730 write(istdpr,*) 'opintf: error in common-array ndat'
d     ier=2
d     return
d9740 write(istdpr,*) 'opintf: error in common-array ntab'
d     ier=2
d     return
d9750 write(istdpr,*) 'opintf: error in common-array nzva'
d     ier=2
d     return
d9760 write(istdpr,*) 'opintf: error in common-array niwkl'
d     ier=2
d     return
d9770 write(istdpr,*) 'opintf: error in common-array nwkl'
d     ier=2
d     return
 9810 if(istdpr.gt.0) then
	write(istdpr,*) 
     *    'opintf: **Warning** interpolation point outside',
...
c
     ...
     +          write(istdpr,*) 'opintf: ***Error*** in extrapolation'
