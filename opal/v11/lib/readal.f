...
c
      return
c
9030  write(istdou,*) 'readal: open error of ',alxtab
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readal: open error of ',alxtab
      stop 'in readal'
9700  write(istdou,*) 'readal: inconsistency-error of iz= ',iz 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readal: inconsistency-error of iz= ',iz 
      stop 'in readal'
9705  write(istdou,*) 'readal: inconsistency-error of ix= ',ix 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readal: inconsistency-error of ix= ',ix 
      stop 'in readal'
9720  write(istdou,*) 'readal: inconsistency-error of it= ',it 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
