...
c
      return
c
9030  write(istdou,*) 'readkx: open error of ',kurtab
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readkx: open error of ',kurtab
      stop 'in dreadkx'
9705  write(istdou,*) 'readkx: inconsistency-error of opkx,ix= ',ix 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readkx: inconsistency-error of opkx,ix= ',ix 
      stop 'in dreadkx'
9710  write(istdou,*) 'readkx: inconsistency-error of opkx,iz= ',iz 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readkx: inconsistency-error of opkx,iz= ',iz 
      stop 'in dreadkx'
9720  write(istdou,*) 'readkx: inconsistency-error of tlk,mt= ',mt 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *  'readkx: inconsistency-error of tlk,mt= ',mt 
      stop 'in dreadkx'
9730  write(istdou,*) 'readkx: inconsistency-error of rlk,md= ',md 
      if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
