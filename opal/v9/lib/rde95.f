...
c
	return
c
 9001   write(istdou,*) 'rde95: error in opening ',ifname,'lun= ',lun
        if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *    'rde95: error in opening ',ifname,'lun= ',lun
	stop 'in rde95'
 9011   write(istdou,*) 'rde95: error in opening ',ofname,'lun= ',lun+1
        if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *    'rde95: error in opening ',ofname,'lun= ',lun+1
	stop 'in rde95'
 9002	write(istdou,*) 'rde95: error in read: line: ',j
     	if(istdpr.gt.0.and.istdpr.ne.istdou) write(istdpr,*) 
     *    'rde95: error in read: line: ',j
	stop 'in rde95'
c
	end
