...
c
 ...
 1015   continue
     ...
     *    'reade: last table ',j-1,' lines read'
...
c
	return
c
 9001   write(istdou,*)'reade: error in opening ',ifname,'lun= ',lun
        if(istdpr.ne.istdou.and.istdpr.gt.0) write(istdpr,*)
     *    'reade: error in opening ',ifname,'lun= ',lun
	stop 'in reade'
 9011   write(istdou,*)'reade: error in opening ',ofname,'lun= ',lun+1
        if(istdpr.ne.istdou.and.istdpr.gt.0) write(istdpr,*)
     *    'reade: error in opening ',ofname,'lun= ',lun+1
	stop 'in reade'
 9002	write(istdou,*)'reade: error in read: line: ',j
     	if(istdpr.ne.istdou.and.istdpr.gt.0) write(istdpr,*)
     *    'reade: error in read: line: ',j
	stop 'in reade'
c
	end
