...
c
      if(zval.lt.1.0d-7)then
         write(istdou,'(/,x,a)') '***WARNING*** opintc: setting Z=1.d-7'
         if(istdou.ne.istdpr.and.istdpr.gt.0) write(istdpr,
     *     '(/,x,a)') '***WARNING*** opintc: setting Z=1.d-7'
         zval=1.0d-7
         zvall=-7.0d0
      else
         zvall=dlog10(zval)
...
c
         if(istdpr.gt.0) write(istdpr,'(/,x,a,i1,a,f8.4,a,f8.4)')
...
c
c
d9710 write(istdpr,*)'opintc: error in common-array nxir'
d     ier=2
d     return
d9720 write(istdpr,*)'opintc: error in common-array nyir'
d     ier=2
d     return
d9730 write(istdpr,*)'opintc: error in common-array ndat'
d     ier=2
d     return
d9740 write(istdpr,*)'opintc: error in common-array ntab'
d     ier=2
d     return
d9750 write(istdpr,*)'opintc: error in common-array nzva'
d     ier=2
d     return
d9760 write(istdpr,*)'opintc: error in common-array niwkl'
d     ier=2
d     return
d9770 write(istdpr,*)'opintc: error in common-array nwkl'
d     ier=2
d     return
      ...
      do 5010 l=nzvab,nzvae
        do 5001 itab=ntabb,ntabe
          do 5020 ii=1,nexp+1
             ...
             if(ier.ne.0) then
                write(istdou,*)'opintc: ***Error*** in extrapolation'
                if(istdpr.ne.istdou.and.istdpr.gt.0) write(istdpr,*)
     *            'opintc: ***Error*** in extrapolation'
	     end if
