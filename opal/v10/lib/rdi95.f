...
c      05/10/02: midified for OPSL02 tables (Frank Pipers)
c
...
c
	return
c
 9001   write(istder,*) 'readi: error in open statement'
        write(istdou,*) 'readi: error in open statement'
        if(istdpr.gt.0) write(istdpr,*) 'readi: error in open statement'
	stop
 9002	write(istder,*) 'readi: error in read: line: ',j
     	write(istdou,*) 'readi: error in read: line: ',j
     	if(istdpr.gt.0) write(istdpr,*) 'readi: error in read: line: ',j
	stop
c
	end
