...
c
      return
c
9030  write(istder,*) 'readkx: open error of ',kurtab
      write(istdou,*) 'readkx: open error of ',kurtab
      if(istdpr.gt.0) write(istdpr,*) 'readkx: open error of ',kurtab
      stop
9705  write(istder,*) 'readkx: inconsistency-error of opkx,ix= ',ix 
      write(istdou,*) 'readkx: inconsistency-error of opkx,ix= ',ix 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readkx: inconsistency-error of opkx,ix= ',ix 
      stop
9710  write(istder,*) 'readkx: inconsistency-error of opkx,iz= ',iz 
      write(istdou,*) 'readkx: inconsistency-error of opkx,iz= ',iz 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readkx: inconsistency-error of opkx,iz= ',iz 
      stop
9720  write(istder,*) 'readkx: inconsistency-error of tlk,mt= ',mt 
      write(istdou,*) 'readkx: inconsistency-error of tlk,mt= ',mt 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readkx: inconsistency-error of tlk,mt= ',mt 
      stop
9730  write(istder,*) 'readkx: inconsistency-error of rlk,md= ',md 
      write(istdou,*) 'readkx: inconsistency-error of rlk,md= ',md 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readkx: inconsistency-error of rlk,md= ',md 
      stop
c
      end
