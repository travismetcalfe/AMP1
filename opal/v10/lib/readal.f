...
c
c       06/04/95  creation
c       10/05/03  adapted for version 10 (v10) of opint package
c
c    Last modification: 10/05/03
c       
c    input variables:
c    ----------------
...
c           if(irr.ne.ir)goto 9730                     ! 10/05/03
c-----------read tlgalx
...
c
      return
c
9030  write(istder,*) 'readal: open error of ',alxtab
      write(istdou,*) 'readal: open error of ',alxtab
      if(istdpr.gt.0) write(istdpr,*) 'readal: open error of ',alxtab
      stop
9700  write(istder,*) 'readal: inconsistency-error of iz= ',iz 
      write(istdou,*) 'readal: inconsistency-error of iz= ',iz 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readal: inconsistency-error of iz= ',iz 
      stop
9705  write(istder,*) 'readal: inconsistency-error of ix= ',ix 
      write(istdou,*) 'readal: inconsistency-error of ix= ',ix 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readal: inconsistency-error of ix= ',ix 
      stop
9720  write(istder,*) 'readal: inconsistency-error of it= ',it 
      write(istdou,*) 'readal: inconsistency-error of it= ',it 
      if(istdpr.gt.0) write(istdpr,*) 
     *  'readal: inconsistency-error of it= ',it 
      stop
c
      end
