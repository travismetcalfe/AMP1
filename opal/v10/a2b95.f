...
c
c      last modification: 16/04/2003
c
c      Variables:
...
c     initialize output filename
      data   ofname
     +       /'opal02.bin'/      ! to have the same fn as in lib_Z/rde95.f
c                                ! and rename opal02.bin->opal95.bin
c                                ! in Makefile.df95
c
c     open outputfile
...
c       read 1st 5 lines 
        do 1001 i=1,5
         read(lun,'(a)') line
           if (i.eq.2) write(istdpr,*)line(1:60)
 1001   continue      
c
...
c       read/write logT & opacity-values
     ...
     +           tlg(j,k)           ,(opa(i,j,k),i=1,nval)
 1010   continue
c       write(istdpr,*)'a2b95: ',j-1,' lines read in file ',ifname
 1015  continue
 3001 continue
      close(lun+1)
c
      stop
c
 9001 write(istdpr,*)'a2b95: error in opening ',ifname,'lun= ',lun
      stop
 9011 write(istdpr,*)'a2b95: error in opening ',ofname,'lun= ',lun+1
      stop
 9002 write(istdpr,*)'a2b95: error in reading: line: ',j
      stop
 9020 write(istdpr,*)'a2b95: error in writing ',ofname,'lun= ',lun+1 
      stop
c
      end
