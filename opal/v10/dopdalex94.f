...
c     read the opacity-tables (OPAL95 + ALEX94)
      write(istdpr,*)'read OPAL02 tables...'
      call rdi95(lun,optabe,ntab,nxir,nyir,nzva,rlg,tlg,opa,ival)
      write(istdpr,*)'read ALEX94 tables...'
...
c
      print '(/,a)','evaluate partial derivatives for OPAL02+ALEX94'
      print '(a,/)','----------------------------------------------'
      write(nout,8610)
...
9030  write(istdpr,*)'dopdalex94: ERROR in opening of OPINTPATH'
      stop
c
      end
c
