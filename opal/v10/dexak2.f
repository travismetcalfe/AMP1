...
9010  write(istdpr,*)'dexak2: error in opening of file ',ivadat
      stop
9030  write(istdpr,*)'dexak2: error in opening of OPINTPATH'
      write(istdpr,*)'dexak2: try to assign a logical name to OPINTPATH'
      write(istdpr,*)
     *  'dexak2: with setenv OPINTPATH <absolute_path_name> in '
      write(istdpr,*)
     *  'dexak2: a csh where <absolute_path_name> is the file '
      write(istdpr,*)'dexak2: containing the absolute pathnames of the '
      write(istdpr,*)
     *  'dexak2: input files optabe.bin, pderivs.dat, ival.dat'
      stop
c
      end
