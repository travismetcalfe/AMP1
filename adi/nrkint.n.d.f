...
c
      ...
      dimension x(1),y(iy,1),ap(1),aq(1),zk(1),iv(8),ea(100)
...
c
	...
	if(ii.eq.4) then
	  write(istdou,108) 
	  if(istdpr.ne.istdou.and.istdpr.gt.0) write(istdou,108) 
	  icry=-1
	  return
        else
	  iv(1)=2
...
c
          ...
          nwr2=nfit12+5
          n1=1
          write(istdpr,125) n1,x1(1),(y1(i,1),i=1,4),
...
c
      implicit double precision (a-h,o-z)
      dimension y1(1),y2(1),zk1(1),zk2(1),ap(1),aq(1),g(1),gd(ia,1)
c
      common/sysord/ ii
      common/cnrkbc/ cbc(4,4),cavc(4,4),cavs(4,4),isngbt,isngsf,ibcnrk,
     *  nnq1,nnq2,idgnrk,ibotb1
...
c
      implicit double precision (a-h,o-z)
      dimension y(1),zk(1),ap(1),aq(1),f(1),fd(ia,1),h(1),hd(1),
     *  finh(100)
...
c
     ...
     *    nfit11,nfit12,nns1,iasnc
        if(istdpr.ne.istdou.and.istdpr.gt.0) then
          ...
          if(nxdiag.le.2) write(istdpr,125)
     *      imcase,nibcc,nev1c,nfitc,nns,nev11,nev12,
     *      nfit11,nfit12,nns1,iasnc
        end if
      end if
c
   22 call rhs(x,fd,finh,ia,n)
c
