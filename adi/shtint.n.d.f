...
c
        call geninh(x(nibc),y(1,nibc),rhs,ii,iy,ig,isn,nd1,nni1,
     *    mdintg,iclcn)
...
c
      if(nni2.gt.1) then
        el1=0
        call geninh(x(nev1),y(1,nev1),rhs,ii,iy,ig,isn,nd2,nni2,
     *    mdintg,iclcn)
...
c  the integration
c
      call geninh(x(nd),y(1,ny),rhs,ii,iy,ig,isn,nd,nnis,
     *  mdintg,iclcn)
c
