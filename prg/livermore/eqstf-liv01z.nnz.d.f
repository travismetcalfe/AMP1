...
c
      common/eeoszt/esact,eoszt(10,nztab)
...
c..	  if(ider.eq.1) 
c..     *      write(6,*) 'iztab, Z, eoszt(4,i):',iztab, zinliv(iztab),
c..     *      eoszt(4,iztab)
	end do
c
...
c..      if(ider.eq.1) write(6,*) 'Cp etc.',
c..     *  cpp, 1.e6*eos(4), ptt*dltt*dltt/(rh*tt*alpha)
