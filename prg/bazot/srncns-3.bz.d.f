...
c
      save
c
      write(6,*) 'istdpr, istdou, ivreng', istdpr, istdou, ivreng
c
...
c Test
c
         write(*,*) "OK for NACRE reaction rates setting"
c
c End test
c
         write(istdpr,150)
 ...
 66     format('Some coefficientts, s(1,3)',e13.5,' a(4) :',e13.5,
	...
	write(istdpr,190) ivreng
	if(istdou.ne.istdpr) write(istdou,190) ivreng
	stop
      end if
c
