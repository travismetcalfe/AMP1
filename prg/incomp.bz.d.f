...
c  May initialize CNO abundances in array y.
...
c
c  Modified 24/1/97, to keep unchanged He3 abundance if xzer3 .lt. 0
c
...
c
c  Modified 5/8/02, preparing for inclusion of 4He burning. This also
...
c
      idiag=2
c
      if(idiag.ge.1.and.istdpr.gt.0) write(istdpr,105) 
